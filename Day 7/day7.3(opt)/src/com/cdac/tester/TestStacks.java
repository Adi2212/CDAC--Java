...
import com.cdac.core.FixedStack;
import com.cdac.core.GrowableStack;
import com.cdac.core.Stack;
        ...
        while (!exit) {
            ...
            case 1:
                if (stack == null) {
                    ...
                    System.out.println("FixedStack selected.");
                } else {
            ...
            case 2:
                if (stack == null) {
                    ...
                    System.out.println("GrowableStack selected.");
                } else {
                    System.out.println("Stack already chosen!");
                }
                break;
