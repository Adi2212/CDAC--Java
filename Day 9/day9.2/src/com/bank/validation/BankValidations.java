...
public class BankValidations {
	...
	public static void validAccountNo(BankAccount current, Object other) throws DuplicateAccountException {
		if (current.equals(other))
			throw new DuplicateAccountException("Account number "+((BankAccount)other).getAccNo()+" already exists!");
	}
